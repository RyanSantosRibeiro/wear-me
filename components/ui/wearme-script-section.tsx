    ...
    <div className="relative group text-white">
      ...
      <div className="bg-[#1e1e1e] rounded-xl p-6 font-mono text-sm shadow-2xl overflow-hidden border border-white/10 relative">
        ...
        <div className="space-y-2 opacity-90">
          ...
          <div>
            <span className="text-purple-400">&lt;script</span> <span className="text-blue-400">src</span>=<span className="text-green-400">"https://wearme.vercel.app/WearMe.js"</span><span className="text-purple-400">&gt;&lt;/script&gt;</span>
          </div>
